...
/// Since AppVisitors is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "AppVisitors_AppVisitors"
        ...
        fatalError("unable to find bundle named AppVisitors_AppVisitors")
    }()
}
